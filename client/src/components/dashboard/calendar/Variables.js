...
const events = [
  ...
  {
    title: "Formation R2981",
    start: new Date(y, m, 21),
    end: new Date(y, m, 22),
    color: "orange"
  },
  {
    title: "Formation R2989",
    start: new Date(y, m, 21),
    end: new Date(y, m, 24),
    color: "orange"
  }
